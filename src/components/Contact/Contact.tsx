  ...
  return (
    <section id="contact" className="py-20 lg:py-32 bg-card/30">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-10 h-[570px]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="w-full lg:w-1/3 flex flex-col justify-between  border rounded-xl shadow-sm p-8 "
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="w-full lg:w-[70%] border rounded-xl shadow-sm p-8 flex flex-col justify-between h-[570px]"
          >
            <div>
