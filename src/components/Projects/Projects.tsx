...
const projects = [
  ...
  },
  {
    title: "BC APPA ",
    description:
      "Collaborative project management platform with kanban boards, time tracking, and team analytics.",
    image: "/bc.png",
...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={containerRef} className="py-32 relative font-[Montserrat]">
